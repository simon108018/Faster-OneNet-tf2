...
class BBoxUtility(object):
    ...
    def onenet_correct_boxes(self, box_xy, box_wh, input_shape, image_shape, letterbox_image):
        # -----------------------------------------------------------------#
    ...
    def postprocess(self, prediction, nms, image_shape, input_shape, letterbox_image, confidence=0.5):
        ...
        for i in range(len(prediction)):
            ...
            if results[i] is not None:
                ...
                results[0][:, :4] = self.onenet_correct_boxes(box_xy, box_wh, input_shape, image_shape,
                                                                 letterbox_image)
